 ...
 */
class getCommanderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommanderRepository' shared autowired service.
     *
     * @return \App\Repository\CommanderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommanderRepository.php';

        return $container->privates['App\\Repository\\CommanderRepository'] = new \App\Repository\CommanderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

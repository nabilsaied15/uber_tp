 ...
 */
class getUser1PhpRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\User1PhpRepository' shared autowired service.
     *
     * @return \App\Repository\User1PhpRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'User1PhpRepository.php';

        return $container->privates['App\\Repository\\User1PhpRepository'] = new \App\Repository\User1PhpRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

 ...
 */
class getVenderRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VenderRepository' shared autowired service.
     *
     * @return \App\Repository\VenderRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VenderRepository.php';

        return $container->privates['App\\Repository\\VenderRepository'] = new \App\Repository\VenderRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
